...
#include <stdbool.h>
    ...
    */
    ...
    void bitShiftingEncryption(char key1, char key2) {
...
int Encrypt(char * FILENAME, char * OUTPUT) {
    ...
    if(inF == NULL) {
        ...
        printf("File Opened, Encrypted File Destination: encryptedOuput.txt \n");
        
        bitShiftingEncryption(key1, key2);          //if a valid file do encryption.
...
void bitShiftingDecryption(char key1, char key2) {
...
int Decrypt(char * FILENAME, char * OUTPUT) {
    ...
    if(inF == NULL) {
        ...
        printf("File Opened, Decrypted File Destination: decryptedOuput.txt \n");
        
        bitShiftingDecryption(key1, key2);      //if a valid file do decryption.
